...
namespace RTLTMPro
{
    [CustomEditor(typeof(RTLTextMeshPro))]
    ...
    public class RTLTextMeshProEditor : TMP_UiEditorPanel
    {
        ...
        protected virtual void DrawOptions()
        {
            ...
            preserveNumbersProp.boolValue =
                GUILayout.Toggle(preserveNumbersProp.boolValue, new GUIContent("Preserve Numbers"));
        ...
        protected virtual void ListenForZeroWidthNoJoiner()
        {
            ...
            var shortcutPressed = (Event.current.modifiers & EventModifiers.Control) != 0 &&
